        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 mt-4">
              <a href="https://facebook.com" className="text-white hover:text-elvec-400 transition-colors duration-300">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path></svg>
              </a>
              <a href="https://instagram.com" className="text-white hover:text-elvec-400 transition-colors duration-300">
              ...
              <a href="https://linkedin.com" className="text-white hover:text-elvec-400 transition-colors duration-300">
              ...
              <a href="https://whatsapp.com" className="text-white hover:text-elvec-400 transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex">
                <Clock className="h-5 w-5 text-elvec-400 mr-3 flex-shrink-0" />
                <div>
                  <p className="text-gray-300">Lun - Ven: 8h00 - 18h00</p>
                  <p className="text-gray-300">Sam: 8h00 - 13h00</p>
